 ...
 * segundo brazo.
 * 
 * The Hulk es sumamente inteligente, pero no es muy diestro en algoritmos. Por
 * otro lado, Tony Stark, quien si sabe de algoritmos, esta muy ocupado buscando
 * el Teseract en 1970.  Por eso, the Hulk te pide a tu ayuda.
 *
